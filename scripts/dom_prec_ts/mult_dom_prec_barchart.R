###################################################
# Title: visualize multiple dom_ave_prec barcharts Rscript 
# Author: Gaku YAMANO
# Date: 2025/08/29
###################################################
# load packages
...
bar_centers <- barplot(height_matrix,
                       ...
                       main = paste0(bin_interval_hr, "-Hourly Domain Average of Precipitation"),
                       xlab = "Time [hour]",
                       ylab = "Precipitation Rate [kg/m^2/2min]",
